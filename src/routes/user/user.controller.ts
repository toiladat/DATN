...
import { GetUserParamsDTO, SearchUserQueryDTO, SearchUserQueryResDTO, UpdateUserProfileBodyDTO } from './user.dto'
@ApiTags('Users')
@Controller('users')
@SkipThrottle()
@ApiBearerAuth()
export class UserController {
  ...
  @ApiResponse({ status: 200, type: GetUserProfileResDTO })
  @ZodSerializerDto(GetUserProfileResDTO)
  updateMe(@ActivateUser('userId') userId: string, @Body() body: UpdateUserProfileBodyDTO) {
